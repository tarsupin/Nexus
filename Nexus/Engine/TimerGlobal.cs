...
namespace Nexus.Engine {
	...
	public class TimerGlobal {
		...
		public int tick20;								// 20 per second, 1 per 3 frames, increments forever. Can use for global timing events.
		...
		public int beat;								// 4 per second, 1 per 15 frames, increments forever. Can use for global timing events.
		...
		public void RunTick() {
			...
			this.tick20 = (int) Math.Floor((double)(this.Frame / 3));
			this.tick20Modulus = (byte)(this.tick20 % 20);
			this.beat = (int) Math.Floor((double)(this.Frame / 15));
