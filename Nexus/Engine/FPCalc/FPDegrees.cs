...
namespace Nexus.Engine {
	...
	public static class FPDegrees {
		...
		public static FInt Wrap( FInt degrees ) { return FPSpectrum.Wrap(degrees, FInt.Create(-180), FInt.Create(180)); }
		public static FInt Normalize( FInt degrees ) { return FPSpectrum.Wrap(degrees, FInt.Create(0), FInt.Create(360)); }
	
		// Reverse the angle
		public static FInt Reverse( FInt degrees ) { return FPDegrees.Normalize(degrees + 180); }

		// Get X, Y coordinates from degree and angle
		public static FInt GetXFromRotation(FInt degrees, FInt distance) { return FPRadians.GetXFromRotation(FPDegrees.ConvertToRadians(degrees), distance); }
