...
// This is an unusual param structure, so I'll have to think about how to implement this. Should be straightforward with the console.
// Some of the code might be useful.
