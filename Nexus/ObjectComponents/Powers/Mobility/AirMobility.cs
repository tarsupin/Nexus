	...
	public class AirMobility : PowerMobility {
		...
		public override void Activate() {
			...
			if(this.character.physics.touch.toBottom) {
				...
				this.character.physics.MoveToPosY((FInt)(this.character.pos.Y.IntValue - 1));
			}

			// Trigger the Air Burst Action
			this.character.action = AirBurst.StartAction(this.character, directionHor, directionVert);
