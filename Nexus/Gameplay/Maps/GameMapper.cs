...
namespace Nexus.Gameplay {
	...
	public static class ActionMap {
		...
		public static readonly TransportAction Transport = new TransportAction();
	...
	public static class AnimCycleMap {
		...
		public static readonly string[] Cycle3BothWays = new string[4] { "1", "2", "3", "2" };
		public static readonly string[] Cycle4 = new string[4] { "1", "2", "3", "4" };
		public static readonly string[] Cycle4Reverse = new string[4] { "4", "3", "2", "1" };
	...
	public class GameMapper {
		...
		public GameMapper(GameClient game, SpriteBatch spriteBatch) {
			...
			MetaList[MetaGroup.BlockMoving] = new IMetaData(Arch.MovingBlock, this.atlas[(byte)AtlasGroup.Objects], SlotGroup.EnemiesFly, LayerEnum.main, LoadOrder.Enemy);
				// Slammer
			MetaList[MetaGroup.Item] = new IMetaData(Arch.Item, this.atlas[(byte)AtlasGroup.Objects], SlotGroup.Fixtures, LayerEnum.obj, LoadOrder.Item);
				// Most Items (but not buttons)
			MetaList[MetaGroup.Button] = new IMetaData(Arch.Item, this.atlas[(byte)AtlasGroup.Objects], SlotGroup.Fixtures, LayerEnum.obj, LoadOrder.Item);
			MetaList[MetaGroup.ButtonFixed] = new IMetaData(Arch.Item, this.atlas[(byte)AtlasGroup.Tiles], SlotGroup.ColorToggles, LayerEnum.main, LoadOrder.Item);
				// Buttons
			MetaList[MetaGroup.Generator] = new IMetaData(Arch.Generator, this.atlas[(byte)AtlasGroup.Objects], SlotGroup.Fixtures, LayerEnum.main, LoadOrder.Tile); // LoadOrder.Block
				// Cannon, Placer
			...
			MetaList[MetaGroup.Interactives] = new IMetaData(Arch.Interactives, this.atlas[(byte)AtlasGroup.Objects], SlotGroup.Interactives, LayerEnum.main, LoadOrder.Tile); // LoadOrder.Interactives
				// Chest, PeekMap
			MetaList[MetaGroup.Flag] = new IMetaData(Arch.Collectable, this.atlas[(byte)AtlasGroup.Objects], SlotGroup.Interactives, LayerEnum.main, LoadOrder.Tile);
			MetaList[MetaGroup.Detect] = new IMetaData(Arch.Decor, this.atlas[(byte)AtlasGroup.Tiles], SlotGroup.None, LayerEnum.main, LoadOrder.Tile);
			...
			MetaList[MetaGroup.Projectile] = new IMetaData(Arch.Projectile, this.atlas[(byte)AtlasGroup.Objects], SlotGroup.None, LayerEnum.main, LoadOrder.Projectile);
			...
			this.ObjectMetaData[(byte)ObjectEnum.Saw] = new GameObjectMetaData(MetaList[MetaGroup.EnemyFly], Params.ParamMap["Flight"], Params.ParamMap["Cluster"]);
			this.ObjectMetaData[(byte)ObjectEnum.Slammer] = new GameObjectMetaData(MetaList[MetaGroup.EnemyFly], Params.ParamMap["Cluster"]);
			...
			this.ObjectMetaData[(byte)ObjectEnum.Bouncer] = new GameObjectMetaData(MetaList[MetaGroup.EnemyFly], Params.ParamMap["MoveBounce"], Params.ParamMap["Cluster"]);
			...
			this.ObjectMetaData[(byte)ObjectEnum.OrbItem] = new GameObjectMetaData(MetaList[MetaGroup.Item], Params.ParamMap["Cluster"]);
			...
			this.ObjectMetaData[(byte)ObjectEnum.Character] = new GameObjectMetaData(MetaList[MetaGroup.Character], Params.ParamMap["Character"], Params.ParamMap["Upgrades"]);
