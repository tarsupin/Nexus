...
namespace Nexus.Gameplay {
	...
	public class GameClass {
		...
		public ushort respawnFrames = 300;						// How many frames before someone respawns.
		public ushort respawnInvincible = 60;					// How many frames is the player invulnerable for after respawn?
		...
		// Timer Limits
		public ushort timeLimit = 0;					// If set, game expires at this duration (in seconds).
		public ushort playDelay = 300;					// The number of frames that the game will wait before starting.
