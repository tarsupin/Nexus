...
namespace Nexus.Objects {
	...
	public class ProjectileMagi : Projectile {
		...
		private ProjectileMagi(RoomScene room, byte subType, GameObject actor, byte numberOfBalls, byte ballNumber) : base(room, subType, FVector.Create(0, 0), FVector.Create(0, 0)) {
		...
		public static ProjectileMagi Create(RoomScene room, byte subType, GameObject actor, byte numberOfBalls, byte ballNumber) {
		...
		public void ResetMagiBall( byte subType, GameObject actor, byte numberOfBalls, byte ballNumber, byte radius = 75, bool isSustained = false ) {
			this.actor = actor;
