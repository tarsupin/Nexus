...
namespace Nexus.Objects {
	...
	class CollectablePower : Collectable {
		...
		public static void TileGenerate(LevelScene scene, ushort gridX, ushort gridY, byte subTypeId) {
			...
			if(!scene.IsClassGameObjectRegistered((byte) ClassGameObjectId.CollectablePower)) {
				new CollectablePower(scene);
			}

			// Add to Tilemap
			scene.tilemap.AddClassTile(gridX, gridY, (byte) ClassGameObjectId.CollectablePower, subTypeId, true, true, false);
		}
